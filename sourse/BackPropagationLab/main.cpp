...
int main(int argc, char** argv) {
	...
	char* trainImagesPath = "train-images.idx3-ubyte";
	char* trainLabelsPath = "train-labels.idx1-ubyte";
	char* testImagesPath = "t10k-images.idx3-ubyte";
	char* testLabelsPath = "t10k-labels.idx1-ubyte";
